...
public class CommandArgs<K, V> {
    ...
    public CommandArgs<K, V> add(Map<K, V> map) {
        ...
        for (Map.Entry<K, V> entry : map.entrySet()) {
            addKey(entry.getKey()).addValue(entry.getValue());//说明：
        }
     ...
     */
    static abstract class SingularArgument {//说明：
    ...
    static class CommandTypeCache {
        ...
        static {
            ...
            CommandType[] values = CommandType.values();//看过了
    ...
    static class ByteBufferArgument {//说明：为啥不继承SingularArgument
    ...
    static class CharArrayArgument extends SingularArgument {
        ...
        static void writeString(ByteBuf target, char[] value) {//char 两个字节
    ...
    static class KeyArgument<K, V> extends SingularArgument {//看过了
        ...
        @Override
        void encode(ByteBuf target) {//看过了
