 ...
 * @author Ben Alex
 * @author Rob Winch
 * 通过修改SecurityContextHolder执行注销。
 * 如果isInvalidateHttpSession（）为true并且会话不为null，也会使HttpSession无效。
 * 如果将clearAuthentication设置为true（默认值），还将从当前的SecurityContext中删除Authentication。
 */
