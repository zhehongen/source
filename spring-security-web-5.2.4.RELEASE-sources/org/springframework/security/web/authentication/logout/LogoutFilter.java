 ...
 * 注销主体。
 * 轮询一系列LogoutHandlers。 应该按要求的顺序指定处理程序。
 * 通常，您将要调用注销处理程序TokenBasedRememberMeServices和SecurityContextLogoutHandler（按此顺序）。
 * 注销后，将重定向到由配置的LogoutSuccessHandler或logoutSuccessUrl确定的URL，具体取决于所使用的构造函数。
 */
