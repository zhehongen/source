 ...
 * 通过使用SecurityContextCallableProcessingInterceptor.beforeConcurrentHandling
 * （org.springframework.web.context.request.NativeWebRequest，Callable）
 * 将SecurityContext填充在Callable上，从而在SecurityContext和Spring Web的WebAsyncManager之间提供集成。
 */
