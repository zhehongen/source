 ...
 *
 * @author Ben Alex         保存与HTTP过滤器关联的对象。
 * @author colin sampaleanu 确保请求和响应是HttpServletRequest和HttpServletResponse的实例，并且不存在空对象。
 * @author Luke Taylor     是必需的，以便安全系统类可以访问过滤器环境以及请求和响应。
 * @author Rob Winch
 */
