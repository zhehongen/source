 ...
 *一个将否定传入的RequestMatcher的RequestMatcher。例如，如果传入的RequestMatcher返回true，则NegatedRequestMatcher将返回false。 如果传入的RequestMatcher返回false，则NegatedRequestMatcher将返回true。
 * @author Rob Winch
 * @since 3.2
 */
