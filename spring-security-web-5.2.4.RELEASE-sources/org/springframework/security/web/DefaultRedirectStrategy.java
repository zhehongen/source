...
public class DefaultRedirectStrategy implements RedirectStrategy {
	 ...
	 * 将响应重定向到提供的URL。
	 * 如果设置了contextRelative，则重定向值将是请求上下文路径之后的值。
	 * 请注意，这将导致协议信息（HTTP或HTTPS）丢失，例如，如果正在执行重定向以更改为HTTPS，则将导致问题。
	 *
	 * 指定者：
	 * 接口RedirectStrategy中的sendRedirect
	 * 参数：
	 * 请求–当前请求
	 * 响应–重定向响应
	 * url –重定向到的目标URL，例如“ / login”
	 */
	 ...
	 * 如果应该计算重定向URL减去协议和上下文路径，则返回true（默认为false）。
	 */
