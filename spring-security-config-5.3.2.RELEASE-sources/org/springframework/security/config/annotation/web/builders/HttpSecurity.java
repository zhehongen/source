...
public final class HttpSecurity extends
	...
	/**使用SAML 2.0服务提供者配置身份验证支持。
	 * Configures authentication support using an SAML 2.0 Service Provider.
	 * <br>
	 * <br>
	 *如SAML V2.0核心，配置文件和绑定规范中所述，使用Web浏览器SSO配置文件，POST和REDIRECT绑定来实现“身份验证流”。
	 ...
	 * <br>
	 * <br>
	 * 使用此功能的先决条件是，您必须具有SAML v2.0身份提供程序以提供断言。服务提供者，依赖方以及远程身份提供者，声明方的表示形式都包含在RelyingPartyRegistration中。
	 ...
	 * <br>
	 * <br>
	 *RelyingPartyRegistration由RelyingPartyRegistrationRepository组成，这是必需的，必须在ApplicationContext中注册或通过saml2Login().relyingPartyRegistrationRepository(..)配置。
	 ...
	 * <br>
	 * <br>
	 *默认配置在“ / login”处提供一个自动生成的登录页面，并在发生身份验证错误时重定向到“ / login？error”。登录页面将显示每个身份提供者以及一个能够启动“身份验证流”的链接。
	 ...
	 *以下示例显示了使用SimpleSamlPhp作为身份验证提供程序所需的最少配置。                                                                                                                                                                                                                                             
	 * <pre>                                                                                                    @Configuration                                                                      
	 * &#064;Configuration                                                                                      	   public class Saml2LoginConfig {                                                                                    
	 ...
	 * 	public static class OAuth2LoginSecurityConfig extends WebSecurityConfigurerAdapter {                    	   		@Override                                                                                                                                                      
	 ...
	 *	}                                                                                                       	                                                                     
	 *                                                                                                          	  	@Bean                                                                
	 *	&#064;Bean                                                                                              	  	public RelyingPartyRegistrationRepository relyingPartyRegistrationRepository() {                                                                            
	 *	public RelyingPartyRegistrationRepository relyingPartyRegistrationRepository() {                        	  		return new InMemoryRelyingPartyRegistrationRepository(this.getSaml2RelyingPartyRegistration());                                                                                                                                                  
	 ...
	 * 	private RelyingPartyRegistration getSaml2RelyingPartyRegistration() {                                   	   		//remote IDP entity ID                                                                                                                                       
	 * 		//remote IDP entity ID                                                                              	   		String idpEntityId = "https://simplesaml-for-spring-saml.cfapps.io/saml2/idp/metadata.php";                                                                                            
	 * 		String idpEntityId = "https://simplesaml-for-spring-saml.cfapps.io/saml2/idp/metadata.php";         	   		//remote WebSSO Endpoint - Where to Send AuthNRequests to                                                                                                                                                                 
	 * 		//remote WebSSO Endpoint - Where to Send AuthNRequests to                                           	   		String webSsoEndpoint = "https://simplesaml-for-spring-saml.cfapps.io/saml2/idp/SSOService.php";                                                                                                                               
	 * 		String webSsoEndpoint = "https://simplesaml-for-spring-saml.cfapps.io/saml2/idp/SSOService.php";    	   		//local registration ID                                                                                                                                                                      
	 * 		//local registration ID                                                                             	   		String registrationId = "simplesamlphp";                                                                                             
	 * 		String registrationId = "simplesamlphp";                                                            	   		//local entity ID - autogenerated based on URL                                                                                                              
	 * 		//local entity ID - autogenerated based on URL                                                      	   		String localEntityIdTemplate = "{baseUrl}/saml2/service-provider-metadata/{registrationId}";                                                                                                                    
	 * 		String localEntityIdTemplate = "{baseUrl}/saml2/service-provider-metadata/{registrationId}";        	   		//local signing (and decryption key)                                                                                                                                                                  
	 * 		//local signing (and decryption key)                                                                	   		Saml2X509Credential signingCredential = getSigningCredential();                                                                                                          
	 * 		Saml2X509Credential signingCredential = getSigningCredential();                                     	   		//IDP certificate for verification of incoming messages                                                                                                                                     
	 * 		//IDP certificate for verification of incoming messages                                             	   		Saml2X509Credential idpVerificationCertificate = getVerificationCertificate();                                                                                                                             
	 * 		Saml2X509Credential idpVerificationCertificate = getVerificationCertificate();                      	   		return RelyingPartyRegistration.withRegistrationId(registrationId)                                                                                                                                                    
	 * 		return RelyingPartyRegistration.withRegistrationId(registrationId)                                  	    * 				.remoteIdpEntityId(idpEntityId)                                                                                                                                        
	 *  * 				.remoteIdpEntityId(idpEntityId)                                                         	    * 				.idpWebSsoUrl(webSsoEndpoint)                                                                                                                 
	 *  * 				.idpWebSsoUrl(webSsoEndpoint)                                                           	    * 				.credential(signingCredential)                                                                                                               
	 *  * 				.credential(signingCredential)                                                          	    * 				.credential(idpVerificationCertificate)                                                                                                                
	 *  * 				.credential(idpVerificationCertificate)                                                 	    * 				.localEntityIdTemplate(localEntityIdTemplate)                                                                                                                         
