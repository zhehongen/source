...
public interface XMLObject {
    ...
    /**从其父级分离XMLObject。 这将释放父对象的缓存DOM（如果有），并将此对象的父对象设置为null。 它不会从该对象的父对象中删除该对象，这是此方法的调用者的责任，也不会在新文档中重新植根缓存的DOM节点（如果有）。 这在编组时处理
