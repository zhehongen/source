...
/**表示封装的或分离的XML数字签名的XMLObject，版本20020212，Signature元素。
...
public class SignatureImpl extends AbstractXMLObject implements Signature {
    ...
    /** Canonicalization algorithm used in signature.签名中使用的规范化算法 */
    private String canonicalizationAlgorithm;//说明：ds:CanonicalizationMethod

    /** Algorithm used to generate the signature. */
    private String signatureAlgorithm;//说明：ds:SignatureMethod
    ...
    private KeyInfo keyInfo;//说明：ds:KeyInfo
