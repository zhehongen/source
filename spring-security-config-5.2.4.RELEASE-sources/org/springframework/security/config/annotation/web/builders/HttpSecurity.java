...
public final class HttpSecurity extends
	 ...
	 * @throws Exception
	 * 提供注销支持。使用WebSecurityConfigurerAdapter时，将自动应用此功能。
	 * 默认设置是访问URL“ / logout”将使HTTP会话无效，清理配置的所有RememberMe（）身份验证，
	 * 清除SecurityContextHolder，然后重定向到“ / login？success”，从而注销用户。
	 * 定制配置示例
	 * 以下自定义将在调用URL“ / custom-logout”时注销。注销将删除名为“ remove”的cookie，
	 * 不使HttpSession无效，清除SecurityContextHolder，并在完成后重定向到“ / logout-success”。
	 *  	 @Configuration
	 *       @EnableWebSecurity
	 *       public class LogoutSecurityConfig extends WebSecurityConfigurerAdapter {
	 *
	 ...
	 * 登录页面的详细信息可以在FormLoginConfigurer.loginPage（String）上找到。
	 @Configuration
	 @EnableWebSecurity
	 public class FormLoginSecurityConfig extends WebSecurityConfigurerAdapter {
