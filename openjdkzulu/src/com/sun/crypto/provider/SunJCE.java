...
public final class SunJCE extends Provider {
    ...
    void putEntries() {
        ...
        List<String> pkcs5MD5_DESAliases =
            createAliasesWithOid("1.2.840.113549.1.5.3");

        List<String> pkcs5MD5_DES_SF_Aliases =
