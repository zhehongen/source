...
public class TlsChannelBinding {
    ...
    public enum TlsChannelBindingType {
        ...
        /**
         * Channel binding on the base of TLS Finished message
         */
        TLS_UNIQUE("tls-unique"),
        /**
         * Channel binding on the base of TLS server certificate
         */
    ...
    public static TlsChannelBindingType parseType(String prop) throws NamingException {
        if (prop != null) {
            if (prop.equals(TlsChannelBindingType.TLS_UNIQUE.getName())) {
                throw new NamingException( "Channel binding type " +
                        TlsChannelBindingType.TLS_UNIQUE.getName() +
                        " is not supported");
            } else if (prop.equals(TlsChannelBindingType.TLS_SERVER_END_POINT.getName())) {
    ...
    /**
     * Construct tls-unique Channel Binding data
    ...
    /**
     * Construct tls-server-point-point Channel Binding data
     * @param serverCertificate
     * @throws SaslException
     */
    public static TlsChannelBinding create(X509Certificate serverCertificate) throws SaslException {
        try {
            final byte[] prefix = "tls-server-end-point:".getBytes();
