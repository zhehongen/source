    ...
    SunEntries(Provider p) {
        ...
        if (NativePRNG.Blocking.isAvailable()) {
            add(p, "SecureRandom", "NativePRNGBlocking",
                "sun.security.provider.NativePRNG$Blocking", null, null);
        }
        if (NativePRNG.NonBlocking.isAvailable()) {
            add(p, "SecureRandom", "NativePRNGNonBlocking",
                "sun.security.provider.NativePRNG$NonBlocking", null, null);
        }
        ...
        attrs.replace("KeySize", "1024", "2048"); // for SHA224 and SHA256 DSA signatures
        ...
        List<String> dsaAliases = createAliasesWithOid("1.2.840.10040.4.1",
                "1.3.14.3.2.12");
         ...
         * Digest engines
         */
        add(p, "MessageDigest", "MD2", "sun.security.provider.MD2", null, null);
