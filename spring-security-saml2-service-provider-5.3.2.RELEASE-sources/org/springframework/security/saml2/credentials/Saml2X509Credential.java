...
/**Saml2X509Credential用于保存X509证书或X509证书和私钥
...
public class Saml2X509Credential {
	...
	/**创建一个Saml2X509Credentials来表示身份提供者的凭据，以进行验证，加密或同时进行两者。
	...
	/**创建一个Saml2X509Credentials来表示（用于签名，解密或两者的）服务提供者凭据。
	 * Creates a Saml2X509Credentials representing Service Provider credentials for
	 * signing, decryption or both.用于签名或解密的私钥，不能为null
	 * @param privateKey a private key used for signing or decryption, cannot be null 与身份提供者共享的SP X509证书，不能为null
