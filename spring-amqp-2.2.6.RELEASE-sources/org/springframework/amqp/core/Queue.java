...
public class Queue extends AbstractDeclarable implements Cloneable {
	...
	/**
	 * Argument key for the master locator.主定位器的参数键
	 * @since 2.1
	 */
	 ...
	 *如果服务器应在不再使用队列时删除该队列（取消最后一个使用方），则为true。 永远没有任何使用者的队列不会自动删除。
