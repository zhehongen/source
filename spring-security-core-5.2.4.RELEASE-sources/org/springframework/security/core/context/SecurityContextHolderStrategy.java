...
/**
 * A strategy for storing security context information against a thread.一种针对线程存储安全上下文信息的策略。
 *首选策略由SecurityContextHolder加载。
 * <p>
...
public interface SecurityContextHolderStrategy {
	 ...
	 * <code>IllegalArgumentException</code> in such cases)上下文–新的参数（永远不能为null，尽管实现必须检查是否已传递null，并在这种情况下抛出IllegalArgumentException）
	 */
	 ...
	 * the first time.
	 *首次创建新上下文时，创建一个新的空上下文实现，以供SecurityContextRepository实现使用。
