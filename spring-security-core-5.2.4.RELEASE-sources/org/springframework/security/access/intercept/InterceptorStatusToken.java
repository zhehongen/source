 ...
 * can tidy up correctly.AbstractSecurityInterceptor子类收到的返回对象。
 *	此类反映了安全拦截的状态，因此对AbstractSecurityInterceptor.afterInvocation（InterceptorStatusToken，Object）的最终调用可以正确整理。
 * @author Ben Alex
 */
public class InterceptorStatusToken {
	...
	private SecurityContext securityContext;//原始的安全上下文
