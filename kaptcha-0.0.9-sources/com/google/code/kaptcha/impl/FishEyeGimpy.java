...
public class FishEyeGimpy implements GimpyEngine
{
	...
	public BufferedImage getDistortedImage(BufferedImage baseImage)
	{
		...
		// create a pixel array of the original image.创建原始图像的像素阵列。
		...
		// put the distortion in the (dead) middle把失真放在（死的）中间
	 ...
	 * @return
	 */
	private double fishEyeFormula(double s)//鱼眼配方
	{
		if (s < 0.0D)
			return 0.0D;
		if (s > 1.0D)
